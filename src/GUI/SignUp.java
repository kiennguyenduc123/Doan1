...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Kiennguyen\\OneDrive\\Documents\\NetBeansProjects\\Doan1\\src\\Icon\\logo.png")); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Dịch Vụ Thuê Cưới");
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(txtPassword, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 270, Short.MAX_VALUE)
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
            User user = new User();
            user.setTendangnhap(this.txtTendangnhap.getText());
            user.setMatkhau(new String(txtPassword.getPassword()));
            user.setHoten(this.txtHoten.getText());
            user.setSdt(this.txtSDT.getText());
            user.setEmail(this.txtEmail.getText());
            user.setDiachi(this.txtDiachi.getText());
            user.setVaitro(this.txtRole.getText());
